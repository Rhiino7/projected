...
public class CompraExitosa extends javax.swing.JFrame {
    ...
    public CompraExitosa(Empresa empresa, DBconnection connection, String name, Usuario user, String nEvento) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(JButton_cerrar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 70, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("<html>Su compra ha sido exitosa. Puede ver sus compras actuales en Mi Perfil.");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 210, 80));
