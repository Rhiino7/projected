...
public class inicioUsuario extends javax.swing.JFrame {
    ...
    private String user;
    public inicioUsuario(Empresa empresa, DBconnection connection, String user) {
        initComponents();
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        ArrayList<String> eventos = empresa.getConnection().selectEventos();
        String[] eventosA = new String[1];
        for (String evento : eventos) {
            eventosA[0] = evento;
            model.addRow(eventosA);
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // TODO add your handling code here:
        this.perfilUsuario = new perfilUsuario(empresa, connection, this, user);
